...
def hybrid_rearrange_box_out(data, one, batch_size, num_anchors):
    ...
    num_anchors: tvm.tir.IntImm or tvm.tir.Var
        Number of anchores. We need to pass it in since hybrid script doesn't support
        binding variable to symbolic dim.
...
@hybrid.script
def hybrid_get_valid_counts(data, score_threshold, id_index, score_index, one, batch_size, num_anchors):
...
@hybrid.script
def hybrid_nms(data, sorted_index, valid_count, indices, batch_size, num_anchors, max_output_size,
